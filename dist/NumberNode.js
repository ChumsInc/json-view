...
const NumberNode = ({ nodeKey, value, collapsed }) => {
    if (collapsed) {
        return (_jsx("span", { className: "json-view--number", children: _jsx("span", { className: "json-view--collapsed-value", children: jsonNodeValue(value) }) }));
    }
