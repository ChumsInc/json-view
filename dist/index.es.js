...
var JSONViewContext = createContext(defaultSettings);
//#endregion
...
var ArrayNode_default = memo(ArrayNode);
//#endregion
...
var ObjectNode = ({ value, nodeKey, open = 0 }) => {
	const [show, setShow] = useState(Math.max(open ?? 0, 0) > 0);
...
var ObjectNode_default = memo(ObjectNode);
//#endregion
...
var JSONView = ({ data, theme, dark, rootNodeName, collapsedStringLength, maxArrayElements, maxObjectElements, defaultOpenLevels }) => {
	const [currentTheme, setCurrentTheme] = useState(google_default);
...
//#endregion
export { JSONView, JSONViewContext, defaultSettings, google_default as google, monokai_default as monokai, preferredThemes };
