...
const CollapsedObjectNode = ({ value }) => {
    ...
    return (_jsxs("span", { className: "json-view--collapsed-object", children: [keys.filter((key, index) => index < 1)
                .map((key, index) => (_jsxs(Fragment, { children: [_jsx(CollapsedNodeKey, { children: key }), _jsx(JSONNode, { nodeKey: key, value: value[key] }, key), index < 4 && index < keys.length - 1 && (_jsx(_Fragment, { children: ", " }))] }, index))), Object.keys(value).length > 1 && (_jsxs("span", { children: ["\u2026", keys.length] }))] }));
};
